...
def update_shopify_inventory(product_id, out_of_stock_sizes, color):
    ...
    for variant in variants:
        if variant.option1 == color:
            ...
            if variant.option2 in out_of_stock_sizes:
                print("Out of stock: ", variant.option1, variant.option2)
                new_level = 0
            else:
                print("Available: ", variant.option1, variant.option2)
                new_level = 10  # or whatever number you want
